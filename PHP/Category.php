...
?>
<?php include ("../CLASS/Xuatttsanpham.php");
$p= new dulieu();
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <link rel="stylesheet" href="../CSS/nutxemthem.css">
      ...
      <div class="row">
        <div class="bottom-nap row col-12 d-flex justify-content-center">
          <ul>
            ...
            <li><a href="#">Giá trị cộng đồng</a></li>
...
<div class="modal fade" id="navbarModal" tabindex="-1" aria-labelledby="navbarModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title mx-3" id="navbarModalLabel" style="color: #504f4f;" >MENU</h2>
  ...
  <div id="loginTable" class="d-none">
      ...
      <h5 class="table-title" style="color: #504f4f;">XIN CHÀO</h5>
      <div class="row">
        <tr>
          <?php
            if ($id_user) {
      ...
      <div class="row">
        <tr>
          <td>
            ...
            <p style="font-size: 9px;">Thành viên nhận ưu đãi VIP và quyền truy cập sớm bộ sưu tập mới</p>
          </td>
        </tr>
      </div>
    </div>
...
<div class="content">
  <div class="row">
    <?php
        $p->slidedanhmuc ("select * from danhmuc ")               
    ?>
  </div>
<!-- them san pham o day -->
  <div class="product-list" id="product-list">
      <div class="row px-5 g-5">
          ...
          if (isset($_GET['id_chinh'])) {
              $id_danhmuc = (int)$_GET['id_chinh'];
              $p->xuatdssanpham("SELECT * FROM sanpham WHERE dm_iddanhmuc = $id_danhmuc");
          } elseif (isset($_GET['id_con'])) {
              $id_danhmuccon = (int)$_GET['id_con'];
              $p->xuatdssanpham("SELECT * FROM sanpham WHERE dmc_idcon = $id_danhmuccon");
          } else {
              $p->xuatdssanpham("SELECT * FROM sanpham WHERE sp_id > $sp_id ORDER BY sp_id LIMIT $limit");
              echo '<div style="text-align: center; margin-top: 20px;">
                      <a href="?sp_id=' . ($sp_id + $limit) . '" class="load-more-btn">
                          Xem thêm
                      </a>
                    </div>';
          }
...
<!-- sản phảm banchay -->
  <div class="product-scroll-container d-md-inline" style="padding-top: 150px;">
  ...
  <!-- Them php sản phẩm bán chạy -->
    <div class="horizontal-product-list">
      <?php
        $p->xuatdssanpham ("SELECT * from sanpham where sp_thuoctinh='banchay'")               
      ?> 
    </div>
  </div>  
</div>
